...
_Note : this repository contains only the `cpp_00` module. It is part of the global [cpp_modules](https://github.com/bibickette/cpp_modules) repository, which regroups all C++ modules._

1. Clone `cpp_00` in a folder first : `git clone https://github.com/bibickette/cpp_00.git`
...
_Project validation date : March 12, 2025_
